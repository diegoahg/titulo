           	...
           	<div class="col-xs-12">
				<div class="box">
	                <div class="box-header">
	                  <h3 class="box-title">Editar Bien Raiz</h3>
	                </div><!-- /.box-header -->
	                <form action="../edit" method="post" enctype="multipart/form-data" class="horizontal-form">
        				<div class="box-body">
							<div class="form-body">
								...
								<input type="hidden" name="_id" value="{{ $bienraiz->id }}">
									<input type="hidden" name="_key" value="{{ Crypt::encrypt($bienraiz->id) }}">
								<div class="row">
										<div class="col-md-3">
		...
		$('#centro').change(function() {
	      ...
	      $(function () {
	        ...
	        //console.log("asd");
	         ...
	         $("#valor_total").val("{{$bienraiz->valor_total}}");
	         ...
	         $("#observacion").html("{{$bienraiz->observacion}}");
	         $("#descripcion").val("{{$bienraiz->descripcion}}");
